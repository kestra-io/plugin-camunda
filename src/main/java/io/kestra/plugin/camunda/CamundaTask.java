    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.camunda.CamundaTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class CamundaTask extends Task implements RunnableTask<CamundaTask.Output> {
    @Schema(
    ...
    @Override
    public CamundaTask.Output run(RunContext runContext) throws Exception {
